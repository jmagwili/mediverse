...
onPhoneChange(event: any){
  ...
  this.page3Validator()
  console.log(this.account, this.isPage3Disabled)
}

page3Validator(){
  this.isPage3Disabled = !(this.firstname && this.lastname && this.birthdate && this.location && this.phone)
} 
...
//   }
this.isPage4Disabled = !(this.tagsSelected.length > 0 )
}
